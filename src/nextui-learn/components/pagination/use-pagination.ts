...
import { HTMLNextUIProps, PropGetter, mapPropsVariants } from "../system"
import { PaginationSlots, PaginationVariantProps, SlotsToClasses, pagination } from "../theme"
import { useDOMRef } from "../utils/dom";
import { Timer, clsx, dataAttr } from "../share-utils";
...
export type UsePaginationProps = Props & PaginationVariantProps & UseBasePaginationProps
...
export function usePagination(originalProps: UsePaginationProps) {
  ...
  function scrollTo(value: number) {
    ...
    if (node) {  // scroll parent to the item
      scrollIntoView(node, {
        scrollMode: "always",
        behavior: "smooth",
        block: "start",
